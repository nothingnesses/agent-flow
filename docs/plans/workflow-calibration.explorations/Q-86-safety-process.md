...
| **Multiple findings and dispositions in one batch** | The full map persists, including low plus critical, valid plus dismissed serious, and parent plus child. Both dismissal outcomes retain the repair component through exhaustion. | The atomic map covers same-owner, cross-owner, owned-plus-unowned, blind-closure, and valid-plus-dismissed-serious products while advancing every affected obligation. | Excluded. |
