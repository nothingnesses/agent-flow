...
THE `Q-78` DESIGN IS ACCEPTED (human, 2026-08-26; closing receipt `q_id:"Q-78"`), AND THIS STEP IS BLOCKED BY NOTHING. The human chose on 2026-08-21 to give the ledger's citations their own step, over keeping them inside `plan-order-array-position` increment 2 and over leaving them alone, receipt `type:"decision"` `q_id:"Q-78-ledgersplit"` in `docs/metrics/workflow.jsonl`.
